...
ecolodApp.controller('eventosCtrl', ['$scope', '$route', 'queryService', 'urlService', '$sce',
    function($scope, $route, queryService, urlService, $sce) 
    {
        $scope.ruta = $route; 
        var query = "PREFIX UMBEL: <http://umbel.org/umbel#> SELECT ?sub WHERE {?sub  UMBEL:isRelatedTo <http://190.14.254.237/dataseteco/RutaDelMaiz/Eventos>.}"
