...
ecolodApp.factory('modalService', ['queryService',
	function(queryService) {
		...
		modalService.selectOne = function(categoria, ruta, parametro, $scope) {
			...
			$scope.dato = []
			query = "PREFIX UMBEL: <http://umbel.org/umbel#> PREFIX FOAF: <http://xmlns.com/foaf/0.1/> SELECT ?sub WHERE {?sub  UMBEL:isRelatedTo <http://190.14.254.237/dataseteco/"+ruta+"/"+categoria+">. ?sub FOAF:depiction <"+parametro+"> .}"								
